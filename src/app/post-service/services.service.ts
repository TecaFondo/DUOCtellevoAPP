...
export class PostServiceService {
  ...
  url = 'http://192.168.86.26:3000/users'; //se tiene que colocar la IP de donde provienen los datos (puede ser una de gihub si fuerna necesario <como el año pasasdo>)
  id= 0;
  //NUEVO PASO 3.2
  httpOptions = {
